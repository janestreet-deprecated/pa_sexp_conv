(* OASIS_START *)
(* DO NOT EDIT (digest: d7fab4a103c0c96728b83a83496019be) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = Some "https://github.com/janestreet/pa_sexp_conv";
          synopsis = "Syntax extension for sexplib";
          description = None;
          categories = [];
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "\241\172\175\150\177\024s,\168y_1\001\212\019|";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
